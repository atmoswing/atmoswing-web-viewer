...
export default function MapViewer() {
  ...
  const { containerRef, mapRef, forecastLayerRef, overlayGroupRef, layerSwitcherRef, mapReady } = useMapInit({ t, runtimeConfig, enqueueSnackbar });
  ...
  useEffect(() => {
    ...
    const id = setTimeout(() => { try { clearBaseDateSearchFailed(); } catch {} }, 2000);
