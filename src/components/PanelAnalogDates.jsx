...
export default function PanelAnalogDates(props) {
    ...
    const columns = [
        { field: 'id', headerName: t('analog.columns.rank'), width: 75 },
        { field: 'date', headerName: t('analog.columns.date'), width: 95, sortable: false },
        { field: 'criteria', headerName: t('analog.columns.criteria'), width: 95 },
    ];
